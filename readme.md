...
- **Bilingüe:** la interfaz del mod sigue el idioma de Zen (español o inglés).
...
- **Bilingual:** the mod UI follows Zen's language (Spanish or English).
...
## 👤 Autor · Licencia / Author · License

Creado por / created by **[@piero-valles-maravi](https://github.com/piero-valles-maravi)**.
